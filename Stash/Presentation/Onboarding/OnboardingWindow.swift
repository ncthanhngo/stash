...
private struct OnboardingView: View {
    ...
    private var header: some View {
        VStack(spacing: 6) {
            ...
            Text("Welcome to Stash").font(.title.weight(.bold))
        ...
        HStack(alignment: .top, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text(accessibilityTrusted
                     ...
                     : "Required so Stash can simulate Cmd+V into other apps. Without it, ⌥N still copies to the clipboard but you'll need to press Cmd+V manually.")
                    .font(.callout)
                    .foregroundColor(.secondary)
