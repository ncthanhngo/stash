...
- Create: `Stash/Domain/Sensitive/SensitivePatternDetector.swift`
- Create: `Stash/Domain/Sensitive/SensitiveKind.swift`  (enum: creditCard, otp, jwt, apiKey)
- Modify: `Stash/Infrastructure/Storage/Migrations.swift` — add v3 migration
- Modify: `Stash/Infrastructure/Storage/ClipboardRecord.swift` — add expires_at field
- Modify: `Stash/Infrastructure/Storage/GRDBClipboardRepository.swift` — set expires_at on insert, add `deleteExpired()`
- Create: `Stash/Infrastructure/Sensitive/SensitiveSweeper.swift`
- Modify: `Stash/Application/AppDelegate.swift` — start SensitiveSweeper
- Modify: `Stash/Presentation/Settings/SettingsView.swift` — toggle "Auto-expire detected secrets"
- Modify: `Stash/Presentation/Popover/HistoryRow.swift` — show countdown badge for items with expires_at
- Create: `StashTests/SensitivePatternDetectorTests.swift`
