...
Beyond the 9 slots — a full snippet library with folders, tags, and **hotstring expansion** (type `;sig` followed by space → expanded to your signature). Cornerstone power-user feature: turns Stash into TextExpander competitor.
...
- Create: `Stash/Domain/Snippet.swift`
- Create: `Stash/Domain/SnippetFolder.swift`
- Create: `Stash/Application/SnippetRepository.swift` (protocol)
- Create: `Stash/Application/SnippetStore.swift`
- Create: `Stash/Application/HotstringEngine.swift`
- Create: `Stash/Infrastructure/Storage/SnippetRecord.swift`
- Create: `Stash/Infrastructure/Storage/SnippetFolderRecord.swift`
- Create: `Stash/Infrastructure/Storage/GRDBSnippetRepository.swift`
- Create: `Stash/Infrastructure/Hotstrings/HotstringMonitor.swift`
- Create: `Stash/Presentation/Snippets/SnippetsView.swift`
- Create: `Stash/Presentation/Snippets/SnippetEditorView.swift`
- Create: `Stash/Presentation/Snippets/FolderTreeView.swift`
- Modify: `Stash/Infrastructure/Storage/Migrations.swift` — add v2 migration
- Modify: `Stash/Presentation/Popover/ClipboardPopoverView.swift` — add tab switcher (History / Snippets)
- Modify: `Stash/Application/AppDelegate.swift` — wire SnippetStore, HotstringEngine, start HotstringMonitor
- Modify: `Stash/Presentation/Settings/SettingsView.swift` — toggle "Enable hotstring expansion"
- Create: `StashTests/HotstringMatcherTests.swift`
- Create: `StashTests/SnippetRepositoryTests.swift`
