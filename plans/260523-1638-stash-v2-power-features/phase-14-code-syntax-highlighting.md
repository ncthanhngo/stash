...
- Create: `Stash/Domain/Syntax/Language.swift`
- Create: `Stash/Domain/Syntax/LanguageDetector.swift`
- Create: `Stash/Domain/Syntax/Tokenizer.swift`
- Create: `Stash/Domain/Syntax/TokenKind.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/SwiftTokenizer.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/JavaScriptTokenizer.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/PythonTokenizer.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/GoTokenizer.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/RustTokenizer.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/BashTokenizer.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/JSONTokenizer.swift`
- Create: `Stash/Domain/Syntax/Tokenizers/YAMLTokenizer.swift`
- Create: `Stash/Presentation/Preview/CodePreview.swift`
- Modify: `Stash/Presentation/Popover/ClipboardPopoverView.swift` — preview pane uses CodePreview when language detected
- Create: `StashTests/LanguageDetectorTests.swift`
- Create: `StashTests/TokenizerSmokeTests.swift`
