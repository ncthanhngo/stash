...
- Modify: `Stash/Presentation/Popover/HistoryRow.swift` — add `.draggable`
- Modify: `Stash/Presentation/Popover/PinnedSlotsBar.swift` — `.draggable` on SlotChip
- Create: `Stash/Domain/DragPayload.swift` — helper to build the right payload per content kind
