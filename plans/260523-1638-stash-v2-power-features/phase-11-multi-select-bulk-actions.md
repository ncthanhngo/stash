...
- Modify: `Stash/Application/ClipboardStore.swift` — add selection state + bulk operations
- Modify: `Stash/Presentation/Popover/HistoryRow.swift` — show selection highlight + checkmark badge
- Modify: `Stash/Presentation/Popover/ClipboardPopoverView.swift` — wire shift/cmd-click + ActionBar
- Create: `Stash/Presentation/Popover/BulkActionBar.swift`
- Modify: `Stash/Presentation/Popover/PopoverKeyMonitor.swift` — handle `⌫` for bulk delete when selection > 1
- Create: `StashTests/BulkSelectionTests.swift`
